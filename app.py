...
def index():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # ✅ FIX: get all 6 return values, including dates
            dates, opens, highs, lows, closes, frame = get_symbol(symbol, time_series)
            print("get_symbol returned", len(dates), "data points")

            # ✅ FIX: pass dates to render_chart
            chart_filename = render_chart(chart_type, dates, opens, highs, lows, closes)
